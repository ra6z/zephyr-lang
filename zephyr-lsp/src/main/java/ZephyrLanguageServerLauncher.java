import io.ra6.zephyr.langserver.ZephyrLanguageServer;
...
/**
 * Standard IO Launcher for Zephyr Language Server.
 */
public class ZephyrLanguageServerLauncher {
    ...
    public static void startServer(InputStream in, OutputStream out) throws InterruptedException, ExecutionException {
        ZephyrLanguageServer server = new ZephyrLanguageServer();
